...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.batchModeCheckBox, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.excludeLabel, 4, 0, 1, 4)

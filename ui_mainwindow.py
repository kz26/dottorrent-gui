...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.commentEdit, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.privateTorrentCheckBox, 4, 0, 1, 2)
        self.md5CheckBox = QtWidgets.QCheckBox(self.optionGroupBox)
        self.md5CheckBox.setObjectName("md5CheckBox")
        self.gridLayout_2.addWidget(self.md5CheckBox, 5, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.batchModeCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>If enabled, a torrent will be created for each directory and file one level below the input directory. Piece size for each torrent will be determined automatically.</p></body></html>"))
